...
randDmg = [round(random.uniform(-0.5, 1), 2), round(random.uniform(-0.5, 1), 2), round(random.uniform(-0.5, 1), 2), 0]
randDist = [round(random.uniform(1, 250), 2), round(random.uniform(1, 250), 2), round(random.uniform(1, 250), 2), 256]
...
#player1.currentAction = et4
player1.ScanEnv(entities)
player1.RLBrain(player1.currentState)